...
<p>great grandmother and great great grandmother and so on passed them selves off as Indian or Spanish</p>
...
<ul>
	...
	<li>Minimum 2-3 years in an IT role that includes customer support and application support.</li>
	<li>Experience in installing software :enterprise software.</li>
	<li>Experience with technical projects</li>
</ul>
<br>
<h6 style="color:RoyalBlue;">SKILLS AND QUALIFICATIONS I CURRENTLY HAVE</h6>
<br>
<ul>
	<li>None<li>
</ul>
<br>
<h6 style="color:RoyalBlue;">PLAN ON HOW I WILL ATTAIN THESE SKILLS.</h6>
<br>
<ul>
	<li>Finish Bachelor of IT through open universities.</li>
	<li>Aquarius software is used for the water industry.</li>  
	<li>Learn Aquarius software , the company runs paid courses on their software.</li>
	<li>Spend time online studying the companies archives which are available.</li>
	<li>Do further courses via open universities in programming, web programming.</li>
	<li>Off to work for a day a week as a volunteer to gain experience.</li>
</ul>
<br>

<h6 id="PP" style="color:RoyalBlue;">PERSONAL PROFILE</h6>
<br>
<h6 id="MT" style="color:RoyalBlue;">MYERS-BRIGGS TYPE (MBTI) TEST</h6>
<br>
<h6 id="RT" style="color:RoyalBlue;">RESULTS</h6>
<br>
<p> ISTP</p>
<br>
<p>INTROVERSION  SENSING  THINKING PERCEIVING.</p>
<br>
<h6>According to Myers-Briggs  people who are ISTP are:</h6>
<br>
<ul>
	<li>observe what is going around them.</li>
	<li>When needed they move quickly to the core of the problem</li>
	<li>not great at following a set schedule</li>
	<li>we solve problems and issues using facts and data-indeed-apply-phone</li>
	<li>Value home, family, autonomy.</li>
	<li>Interested in cause and effect</li>
	<li>organise facts using logical principles</li>
</ul>
<br>
<h6 style="color:RoyalBlue;">LEARNING STYLES TEST</h6>
<br>
<a href="http://educationplanner.org/students/self-assessments/learning-styles.shtml/"></a>
<br>
<h6 style="color:RoyalBlue;">SCORES:</h6>
<br>
<ul>
	<li>Auditory 35%</li>
	<li>Visual 35%</li>
...
<p></p>
<p>According to the results I am a auditory/ visual learner</p>
<p></p>
<p>This means</p>
<p></p>
<ul>
	<li>I learn best by seeing how things are done.</li>
	<li>Also having information explained in verbal terms.</li>
	<li>It means I need to see and hear things together to learn the best.</li>
</ul>
<p></p>
<p></p>
...
<p style="color:MediumVioletRed;">The product will feature a big icon with the words CommunicateMe  with its own logo.  It will also come with read.me files for installers ad about information for the end user. </p>
